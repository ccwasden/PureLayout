...
- (void)testAutoCenterInSuperview
{
    ...
    PL__ALAssertCenterEquals(self.viewA, 500.0, 500.0);
    PL__ALAssertFrameEquals(self.viewA, 450.0, 450.0, 100.0, 100.0);
    
    [self.viewB autoSetDimensionsToSize:CGSizeMake(80.0, 124.0)];
    [self.viewB autoCenterInSuperview];
    [self evaluateConstraints];
    PL__ALAssertCenterEquals(self.viewB, 500.0, 500.0);
    PL__ALAssertFrameEquals(self.viewB, 460.0, 438.0, 80.0, 124.0);
}
