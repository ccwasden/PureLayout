...
{
    PL_NSArray_of(NSLayoutConstraint *) *constraints = [[self.viewC autoCenterInSuperview] autoIdentifyConstraints:@"IdentifyConstraints1"];
...
- (void)testIdentifyConstraintsCreatedWithoutInstalling
{
    ...
    __block PL_NSArray_of(NSLayoutConstraint *) *c4s;
    PL_NSArray_of(NSLayoutConstraint *) *constraints = [NSLayoutConstraint autoCreateConstraintsWithoutInstalling:^{
...
- (void)testSetIdentifierForConstraints
{
    ...
    __block PL_NSArray_of(NSLayoutConstraint *) *c2s;
