...
- (BOOL)allConstraintsAreActivated:(PL_NSArray_of(NSLayoutConstraint *) *)constraints
{
...
- (BOOL)noConstraintsAreActivated:(PL_NSArray_of(NSLayoutConstraint *) *)constraints
{
...
- (void)testCreateAndInstallConstraints
{
    ...
    PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints = [NSLayoutConstraint autoCreateAndInstallConstraints:^{
...
{
    __block PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints1_1 = nil;
    __block PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints1_1_1 = nil;
    __block PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints1_2 = nil;
    
    PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints1 = [NSLayoutConstraint autoCreateAndInstallConstraints:^{
...
{
    __NSMutableArray_of(NSLayoutConstraint *) *createdConstraints = [NSMutableArray array];
    PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints = [NSLayoutConstraint autoCreateConstraintsWithoutInstalling:^{
...
- (void)testCreateConstraintsWithoutInstallingNested
{
    ...
    PL_NSArray_of(NSLayoutConstraint *) *returnedConstraints1 = [NSLayoutConstraint autoCreateConstraintsWithoutInstalling:^{
        [self.viewA autoPinEdgeToSuperviewEdge:ALEdgeTop];
