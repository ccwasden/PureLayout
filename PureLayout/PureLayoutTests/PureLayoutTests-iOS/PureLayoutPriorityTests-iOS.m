 ...
 */
- (PL_NSArray_of(NSNumber *) *)defaultPriorities
{
 ...
 */
- (void)assertConstraintsAreAddedWithDefaultPriorities:(PL_NSArray_of(NSLayoutConstraint *) *(^)())block
{
    for (NSNumber *layoutPriority in [self defaultPriorities]) {
...
{
    [self assertConstraints:^PL_NSArray_of(NSLayoutConstraint *) *{ return @[block()]; } areAddedWithPriority:priority];
}
 ...
 */
- (void)assertConstraints:(PL_NSArray_of(NSLayoutConstraint *) *(^)())block areAddedWithPriority:(ALLayoutPriority)priority
{
    __block PL_NSArray_of(NSLayoutConstraint *) *constraints;
