...
#define PL_ALAssertFrameEquals(view, x, y, w, h)       XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMinY(view.frame), y) && ROUNDED_EQUALS(CGRectGetWidth(view.frame), w) && ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
#define PL_ALAssertOriginEquals(view, x, y)            XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMinY(view.frame), y))
#define PL_ALAssertCenterEquals(view, x, y)            XCTAssert(ROUNDED_EQUALS(CGRectGetMidX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMidY(view.frame), y))
#define PL_ALAssertMaxEquals(view, x, y)               XCTAssert(ROUNDED_EQUALS(CGRectGetMaxX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMaxY(view.frame), y))
#define PL_ALAssertSizeEquals(view, w, h)              XCTAssert(ROUNDED_EQUALS(CGRectGetWidth(view.frame), w) && ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
#define PL_ALAssertOriginXEquals(view, x)              XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x))
#define PL_ALAssertOriginYEquals(view, y)              XCTAssert(ROUNDED_EQUALS(CGRectGetMinY(view.frame), y))
#define PL_ALAssertCenterXEquals(view, x)              XCTAssert(ROUNDED_EQUALS(CGRectGetMidX(view.frame), x))
#define PL_ALAssertCenterYEquals(view, y)              XCTAssert(ROUNDED_EQUALS(CGRectGetMidY(view.frame), y))
#define PL_ALAssertMaxXEquals(view, x)                 XCTAssert(ROUNDED_EQUALS(CGRectGetMaxX(view.frame), x))
#define PL_ALAssertMaxYEquals(view, y)                 XCTAssert(ROUNDED_EQUALS(CGRectGetMaxY(view.frame), y))
#define PL_ALAssertWidthEquals(view, w)                XCTAssert(ROUNDED_EQUALS(CGRectGetWidth(view.frame), w))
#define PL_ALAssertHeightEquals(view, h)               XCTAssert(ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
