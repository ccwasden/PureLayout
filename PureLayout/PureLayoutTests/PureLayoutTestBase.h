...
#define PL__ALAssertFrameEquals(view, x, y, w, h)       XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMinY(view.frame), y) && ROUNDED_EQUALS(CGRectGetWidth(view.frame), w) && ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
#define PL__ALAssertOriginEquals(view, x, y)            XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMinY(view.frame), y))
#define PL__ALAssertCenterEquals(view, x, y)            XCTAssert(ROUNDED_EQUALS(CGRectGetMidX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMidY(view.frame), y))
#define PL__ALAssertMaxEquals(view, x, y)               XCTAssert(ROUNDED_EQUALS(CGRectGetMaxX(view.frame), x) && ROUNDED_EQUALS(CGRectGetMaxY(view.frame), y))
#define PL__ALAssertSizeEquals(view, w, h)              XCTAssert(ROUNDED_EQUALS(CGRectGetWidth(view.frame), w) && ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
#define PL__ALAssertOriginXEquals(view, x)              XCTAssert(ROUNDED_EQUALS(CGRectGetMinX(view.frame), x))
#define PL__ALAssertOriginYEquals(view, y)              XCTAssert(ROUNDED_EQUALS(CGRectGetMinY(view.frame), y))
#define PL__ALAssertCenterXEquals(view, x)              XCTAssert(ROUNDED_EQUALS(CGRectGetMidX(view.frame), x))
#define PL__ALAssertCenterYEquals(view, y)              XCTAssert(ROUNDED_EQUALS(CGRectGetMidY(view.frame), y))
#define PL__ALAssertMaxXEquals(view, x)                 XCTAssert(ROUNDED_EQUALS(CGRectGetMaxX(view.frame), x))
#define PL__ALAssertMaxYEquals(view, y)                 XCTAssert(ROUNDED_EQUALS(CGRectGetMaxY(view.frame), y))
#define PL__ALAssertWidthEquals(view, w)                XCTAssert(ROUNDED_EQUALS(CGRectGetWidth(view.frame), w))
#define PL__ALAssertHeightEquals(view, h)               XCTAssert(ROUNDED_EQUALS(CGRectGetHeight(view.frame), h))
