...
- (void)testAutoPinEdgeToSuperviewEdge
{
    ...
    PL__ALAssertOriginEquals(self.viewA, 5.0, VALUES(10.0, 990.0));
    ...
    [self evaluateConstraints];
    PL__ALAssertFrameEquals(self.viewA, 5.0, VALUES(10.0, -10.0), kContainerViewWidth - 5.0, kContainerViewHeight);
    ...
    [self evaluateConstraints];
    PL__ALAssertMaxEquals(self.viewB, kContainerViewWidth, VALUES(kContainerViewHeight + 52.0, -52.0));
    
    [self.viewB autoPinEdgeToSuperviewEdge:ALEdgeLeading withInset:500.0];
    [self evaluateConstraints];
    PL__ALAssertOriginXEquals(self.viewB, 500.0);
    
    [self.viewB autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:0.0];
    [self evaluateConstraints];
    PL__ALAssertFrameEquals(self.viewB, 500.0, VALUES(0.0, -52.0), kContainerViewWidth - 500.0, kContainerViewHeight + 52.0);
}
