...
{
    PL_NSArray_of(NSLayoutConstraint *) *constraints = nil;
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedHorizontallyWithSpacing:(CGFloat)spacing
{
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedHorizontallyWithWidth:(CGFloat)width
{
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedVerticallyWithSpacing:(CGFloat)singleSpace
{
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedVerticallyWithHeight:(CGFloat)height
{
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedHorizontallyWithWidth:(CGFloat)width andSpacing:(CGFloat)spacing
{
...
- (void)assertViews:(PL_NSArray_of(ALView *) *)views areDistributedVerticallyWithHeight:(CGFloat)height andSpacing:(CGFloat)spacing
{
...
- (PL_NSArray_of(ALView *) *)viewArray
{
